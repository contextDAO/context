...
export type UniteFunction = 'transfer' | 'mint' | 'balance' | 'register' | 'registerSchema' | 'getSchema';

export type UniteResult = { state: UniteState } | { result: PstResult } | { result: SchemaResult };
